...
{
    mTitle = "Nah-rio";
    mFont.loadFromFile(R"(C:\Users\conta\Downloads\karmatic-arcade\ka1.ttf)");
...
//        sceneGameEngine->changeScene("PLAY", std::make_shared<ScenePlay>(sceneGameEngine, "haha"));
// Why does this fucking work? If it works, it works. ig?
        sceneGameEngine->changeScene(sceneGameEngine, mLevelPaths[mSelectedMenuIndex]);
    }
